...
@WebMvcTest(controllers = HelloController.class, //@WebMvcTest는 SecurityConfig은 읽지만 CustomOAuth2UserService는 읽지 못한다.
        excludeFilters = { //따라서 다음과 같이 스캔 대상에서 SecurityConfig을 제거한다. 사실 언제 삭제될지도 모르니 사용하지 말자.
          @ComponentScan.Filter(type= FilterType.ASSIGNABLE_TYPE, classes = SecurityConfig.class)
        }) //WebMvc를 테스트하겠다고 선언하는 어노테이션이다.
